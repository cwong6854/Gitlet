...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        count = 0
        step = self.place
        while step.is_hive is False:
            if step.bees and count >= self.min_range and count <= self.max_range:
                return choose_bee(step.bees)
            else:
                step = step.entrance
                count += 1
...
class FireAnt(Ant):
    ...
    damage = 3
    food_cost = 5
    # OVERRIDE CLASS ATTRIBUTES 00HERE
    # BEGIN Problem 5
...
# BEGIN Problem 7
class HungryAnt(Ant):
    """ An Ant that will eat a whole Bee. After eating a Bee, it must spend 3 turns
    chewing before eating again. 
    """
    name = 'Hungry'
    implemented = True
    food_cost = 4
    ...
    def action(self, gamestate):
        ...
        elif not choose_bee(self.place.bees):
            return 
        else:
...
class ScubaThrower(ThrowerAnt):
    """ Water Thrower Ant that is waterproof, and can attack in water. """
    name = 'Scuba'
    food_cost = 6
    implemented = True
    is_waterproof = True
...
# END Problem EC
    ...
    def __init__(self, health=1):
        # BEGIN Problem EC
        super().__init__(health)
        self.imposter = QueenAnt.real == False # <--- creates a different instance
        QueenAnt.real = False
        # END Problem EC
    ...
    def action(self, gamestate):
        ...
        if imposter: # if the queen is an imposter, don't do anything else, only reduce health of imposter
    ...
    def reduce_health(self, amount):
        ...
        if self.health <= 0 and not self.imposter:
            bees_win()
        # END Problem EC
    def remove_from(self, place):
